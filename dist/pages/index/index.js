...
var Header = function Header(props) {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])({
    height: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_3__["getPageHeaderHeight"])(),
    statusBarHeight: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_3__["getStatusBarHeight"])(),
    offset: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_3__["getStatusBarOffset"])()
  }),
      _useState2 = _slicedToArray(_useState, 2),
      _useState2$ = _useState2[0],
      height = _useState2$.height,
      statusBarHeight = _useState2$.statusBarHeight,
      offset = _useState2$.offset,
      setState = _useState2[1]; // 获取侧边导航
  ...
  var getHead = function getHead() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_1__["View"], {
      className: "page-header_head",
      style: {
        top: offset + 'rpx'
      }
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_1__["Image"], {
      className: "_head-icon",
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_1__["View"], {
    ...
    className: "page-header_status",
    style: {
      height: statusBarHeight
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_1__["View"], {
    className: "page-header_content",
    style: {
      height: height,
      lineHeight: height
    }
  }, sideView(), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_1__["Text"], null, props.title)));
};
...
/* harmony import */ var _request_api_main__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/request/api/main */ "./src/request/api/main.ts");
...
var MapContent = /*#__PURE__*/function (_Component) {
  _inherits(MapContent, _Component);

  var _super = _createSuper(MapContent);
  ...
  function MapContent(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getMapConfig", function (params) {
      return Object.assign({}, _this.state.mapConfig, params);
    });

    _defineProperty(_assertThisInitialized(_this), "onClickMarker", function (e) {
      var markers = (_this.state.mapConfig.markers || []).concat();
      var currentMarker = null; // 修改 大小
      ...
      if (currentMarker) {
        _this.props.setCurrentMarker(currentMarker);
      }
    });

    _defineProperty(_assertThisInitialized(_this), "initMapComplate", function (lng, lat) {
      if (!_this.state.init && _this.state.mapContext && lng && lat) {
        _this.state.mapContext.moveToLocation({
          longitude: lng,
          latitude: lat
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "initMap", function () {
      Object(remax_wechat__WEBPACK_IMPORTED_MODULE_2__["getLocation"])({
        type: 'gcj02'
      }).then(function (res) {
        var _config = _this.getMapConfig({
    ...
    _defineProperty(_assertThisInitialized(_this), "getMarker", function () {
      _request_api_main__WEBPACK_IMPORTED_MODULE_5__["MainApi"].getMarkers().then(function (res) {
        var markers = res.map(function (_marker, _index) {
          return _this.createMarker(_marker, _index);
        });

        var _config = Object.assign({}, _this.state.mapConfig, {
          markers: markers
        });
        ...
        var res = [{
          type: 'officeHouses',
          point: '113.943452,22.774649'
        }, {
          type: 'livingHouses',
          point: '113.941735,22.770613'
        }, {
          type: 'livingHouses',
          point: '113.941735,22.765389'
        }, {
          type: 'livingHouses',
          point: '113.948602,22.764202'
        }, {
          type: 'livingHouses',
          point: '113.944654,22.76903'
        }, {
          type: 'officeHouses',
          point: '113.950061,22.769979'
        }, {
          type: 'rentHouses',
          point: '113.954009,22.765389'
        }, {
          type: 'officeHouses',
          point: '113.949289,22.761115'
        }, {
          type: 'livingHouses',
          point: '113.948945,22.756841'
        }, {
          type: 'rentHouses',
          point: '113.943624,22.754942'
        }, {
          type: 'livingHouses',
          point: '113.944139,22.751855'
        }, {
          type: 'officeHouses',
          point: '113.949632,22.750509'
        }, {
          type: 'livingHouses',
          point: '113.956327,22.752488'
        }, {
          type: 'rentHouses',
          point: '113.964223,22.754942'
        }, {
          type: 'rentHouses',
          point: '113.96388,22.762777'
        }, {
          type: 'officeHouses',
          point: '113.958902,22.772591'
        }, {
          type: 'rentHouses',
          point: '113.955211,22.774807'
        }, {
          type: 'livingHouses',
          point: '113.958472,22.763648'
        }, {
          type: 'officeHouses',
          point: '113.960618,22.759453'
        }, {
          type: 'rentHouses',
          point: '113.93444,22.774174'
        }, {
          type: 'officeHouses',
          point: '113.927316,22.780188'
        }, {
          type: 'livingHouses',
          point: '113.926028,22.777181'
        }, {
          type: 'livingHouses',
          point: '113.92517,22.766418'
        }, {
          type: 'livingHouses',
          point: '113.918218,22.759453'
        }, {
          type: 'rentHouses',
          point: '113.912381,22.766497'
        }, {
          type: 'livingHouses',
          point: '113.917875,22.771325'
        }, {
          type: 'livingHouses',
          point: '113.912811,22.775598'
        }, {
          type: 'officeHouses',
          point: '113.92414,22.778526'
        }, {
          type: 'livingHouses',
          point: '113.922252,22.772037'
        }];
        var markers = res.map(function (_marker, _index) {
          return _this.createMarker(_marker, _index);
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "createMarker", function (markerData, index) {
      var _markerData$point$spl = markerData.point.split(','),
          _markerData$point$spl2 = _slicedToArray(_markerData$point$spl, 2),
          longitude = _markerData$point$spl2[0],
          latitude = _markerData$point$spl2[1];
    ...
    _defineProperty(_assertThisInitialized(_this), "distance", function (la1, lo1, la2, lo2) {
      ...
      var offset = s.toFixed(2);
      return offset;
    });

    _defineProperty(_assertThisInitialized(_this), "details", function () {
      if (_this.props.marker && _this.state.currentCenter) {
        var offset = _this.distance(_this.state.currentCenter.lng, _this.state.currentCenter.lat, _this.props.marker.longitude, _this.props.marker.latitude);

        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_2__["CoverView"], {
          className: "marker-details"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_2__["View"], null, "\u8DDD\u79BB", offset + 'm'));
      }
    ...
    _this.state = {
      mapConfig: {
        ...
        setting: {},
        markers: [],
        onMarkerClick: _this.onClickMarker
      },
      markersData: [],
      mapContext: null,
      currentMarker: null,
  ...
  _createClass(MapContent, [{
    ...
    value: function componentDidMount() {
      var mapContext = Object(remax_wechat__WEBPACK_IMPORTED_MODULE_2__["createMapContext"])(this.state.mapConfig.id);
      this.setState({
    ...
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_2__["View"], {
        ...
        style: {
          paddingTop: this.props.pdTop
        }
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(remax_wechat__WEBPACK_IMPORTED_MODULE_2__["Map"], _extends({
        className: "index-map"
      }, this.state.mapConfig)), this.details());
    }
  }]);
...
var _page = function _page() {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])({
    title: '充电桩',
    pdTop: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_6__["getPaddingTop"])(),
    currentMarker: null
  }),
      _useState2 = _slicedToArray(_useState, 2),
      _useState2$ = _useState2[0],
      title = _useState2$.title,
      pdTop = _useState2$.pdTop,
      currentMarker = _useState2$.currentMarker,
      setState = _useState2[1];

  var setCurrentMarker = function setCurrentMarker(marker) {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_header_header__WEBPACK_IMPORTED_MODULE_4__["default"], {
    title: title
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MapContent, {
    pdTop: pdTop,
...
/* harmony import */ var _vari__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vari */ "./src/request/vari.ts");
/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../request */ "./src/request/request.ts");
/*
 * @Descripttion:
 * @version:
 * @Author: david
...
var TEST_PRE_URL = _vari__WEBPACK_IMPORTED_MODULE_0__["BASE_URL"].test;
var TEST_SUFFIX_URL = {
  getMarker: '/getMarker'
};

function getMarkers() {
  return Object(_request__WEBPACK_IMPORTED_MODULE_1__["get"])(TEST_PRE_URL + TEST_SUFFIX_URL.getMarker);
}
...
function requestData(method, url, params) {
...
/*!*****************************!*\
  !*** ./src/request/vari.ts ***!
  \*****************************/
/*! exports provided: BASE_URL, SERVICE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
 ...
 * @version:
 * @Author: david
 * @Date: 2020-08-05 14:56:32
 * @LastEditors: david
 * @LastEditTime: 2020-08-05 14:58:15
 */
var BASE_URL = {
  product: '',
  test: 'http://localhost:8092'
};
var SERVICE = {
  unit: ''
};
...
/*!****************************!*\
  !*** ./src/utils/utils.ts ***!
  \****************************/
/*! exports provided: getMySystemInfo, getPageHeaderHeight, getStatusBarOffset, getStatusBarHeight, copy, getPaddingTop */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMySystemInfo", function() { return getMySystemInfo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPageHeaderHeight", function() { return getPageHeaderHeight; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getStatusBarOffset", function() { return getStatusBarOffset; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getStatusBarHeight", function() { return getStatusBarHeight; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "copy", function() { return copy; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPaddingTop", function() { return getPaddingTop; });
/* harmony import */ var remax_wechat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! remax/wechat */ "./node_modules/remax/wechat.js");
/*
 * @Descripttion:
 * @version:
...
function getMySystemInfo() {
  var systemInfo = Object(remax_wechat__WEBPACK_IMPORTED_MODULE_0__["getSystemInfoSync"])();
  return systemInfo;
}
/**
 * 获取页面顶部高度（不包含状态栏）
...
function getPageHeaderHeight() {
  var height = getStatusBarOffset() + Object(remax_wechat__WEBPACK_IMPORTED_MODULE_0__["getMenuButtonBoundingClientRect"])().height;
  return height * 2 + 'rpx';
}
function getStatusBarOffset() {
  var systemInfo = getMySystemInfo();
  var isIOS = systemInfo.system.indexOf('iOS') > -1;
  var boundButtonInfo = Object(remax_wechat__WEBPACK_IMPORTED_MODULE_0__["getMenuButtonBoundingClientRect"])();
  var offset = isIOS ? 2 : -2;
...
function getPaddingTop() {
  var h = getPageHeaderHeight().replace('rpx', '');
  var s = getStatusBarHeight().replace('rpx', '');
  return +h + +s + 'rpx';
}
...
module.exports = __webpack_require__(/*! /Volumes/work/demo/Remax/test-remax/src/pages/index/index.tsx */"./src/pages/index/index.tsx");
